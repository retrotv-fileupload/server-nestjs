...
export const getSafeFilename = (originalName: string, userAgent?: string): string => {
    ...
    if (isIE) {
        ...
        fallbackName = getIECompatibleName(originalName);
    } else {
        // 기본 ASCII 변환
...
export const mkdir = (...dirs: string[]): void => {
    dirs.forEach(dir => {
...
const getIECompatibleName = (originalName: string): string => {
